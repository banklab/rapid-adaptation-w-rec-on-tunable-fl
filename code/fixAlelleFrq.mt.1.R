...
pdf(paste(args[1], add, "fixAlleleFrq.mt.1.pdf", sep="."), width=2, height=2)

par(mfrow=c(1,1), mai=c(0.4, 0.5, 0.2, 0.02), mgp=c(2,0.5,0), las=1, cex =0.7)
...
steps=floor(L/5)
mtext("Initila freq. of fixed alleles", side=2, line=1.9, cex=0.7, las=0)
